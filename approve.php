<?php 
	...
	$obj=new database();
	$res1=$obj->getfkuseremailbyOrderid($order_id);
...
$message = 'Your Order is Placed Successfully at '.$rest_name.'  !!!'.'<br><br>'.
			'We will deliver it as soon as possible.'.'<br><br>'.
			'Thank you for ordering through LAZEEZO.'. '<br>';
