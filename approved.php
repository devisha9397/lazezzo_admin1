...
$first_page=1;
							...
							$obj=new database();
							$res=$obj->getallapprovedordersbyflag1($restid,$page1,$noi);
				...
				//	echo '<td><font size="4" color="black">'.$row["fk_rest_id"].'</font>';
					...
					echo '<td><center><a href="orderdel.php?id='.$row["order_id"].'"><button type="submit" class="btn btn-danger">
			...
			{	
			echo '<a href="approved.php?page='.$first_page.'" style="text-decoration:none;"><button class="button"><<</button></a>';	
			}
			if($prev_page==0)
			{
			...
			{
		echo '<a href="approved.php?page='.$prev_page.'" style="text-decoration:none;"><button class="button">Previous</button></a>';	
			}
			
			for($b=1;$b<=$a;$b++)
		{
			echo '<a href="approved.php?page='.$b.'" style="text-decoration:none;"><button class="button">'.$b.'</button></a>'; 
		}
		
		if($next_page==$a)
		{
			echo '<a href="approved.php?page='.$next_page.'" style="text-decoration:none;"><button class="button">Next</button></a>';	
		}
		else
		{	
