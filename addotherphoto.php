		...
		<div class="outter-wp">
							<div class="sub-heard-part"></div>
								<div class="graph-visual tables-main">
									<h3 class="inner-tittle two"><center><font size="6" color="blue">Add Other pics  </font></center></h3>
										<div class="graph">
											<div class="tables">		
											...
											<div class="set-1">
												<div class="graph-2 general">
													<div class="grid-1">
														<div class="form-body">
														<form class="form-horizontal" method="post" action="addotherphoto.php" enctype="multipart/form-data">
															...
															<div class="form-group">
																...
																{
																	$other_id="NULL";
																	$otherpic_path="images/".$_FILES["txtofferphoto"]["name"];
																	$ext=pathinfo($otherpic_path,PATHINFO_EXTENSION);
																	//$fk_event_id=0;
